...
<table class="table">
    ...
    <c:forEach var="mailtemplate" items="${mailtemplates}">
        <tr>
            ...
            <td><a href="${SITE_URL}/admin/mailtemplates/edit/${mailtemplate.id}" class="btn btn-success">
                    <span class="glyphicon glyphicon-pencil"/>
                </a> 
                <a href="${SITE_URL}/admin/mailtemplates/delete/${mailtemplate.id}" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')">
